...
class T1Analysis4 : public edm::EDAnalyzer {
   public:
      explicit T1Analysis4(const edm::ParameterSet&);
      ~T1Analysis4();
...
//
T1Analysis4::T1Analysis4(const edm::ParameterSet& iConfig)
...
void
T1Analysis4::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
...
T1Analysis4::endJob() 
{
  ...
  theFile = TFile::Open("T1Analysis4.root", "recreate");
...
void 
T1Analysis4::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
T1Analysis4::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
T1Analysis4::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
T1Analysis4::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
T1Analysis4::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
