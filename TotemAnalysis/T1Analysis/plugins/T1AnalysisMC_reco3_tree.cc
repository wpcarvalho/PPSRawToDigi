...
class T1AnalysisMC_reco3_tree : public edm::EDAnalyzer {
public:
  explicit T1AnalysisMC_reco3_tree(const edm::ParameterSet&);
  ~T1AnalysisMC_reco3_tree();
...
//
T1AnalysisMC_reco3_tree::T1AnalysisMC_reco3_tree(const edm::ParameterSet& iConfig)
...
T1AnalysisMC_reco3_tree::~T1AnalysisMC_reco3_tree()
{
...
void
T1AnalysisMC_reco3_tree::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
...
// Trigger data
/*
  unsigned char TriggerData_type;
  unsigned int TriggerData_event_num, TriggerData_bunch_num, TriggerData_src_id;
  unsigned int TriggerData_orbit_num;
  unsigned char TriggerData_revision_num;
  unsigned int TriggerData_run_num, TriggerData_trigger_num, TriggerData_inhibited_triggers_num, TriggerData_input_status_bits;

  Handle< Totem::RawEvent > input;
  iEvent.getByType(input);

  TriggerData_type = input->triggerData.type;
  TriggerData_event_num = input->triggerData.event_num;
  TriggerData_bunch_num = input->triggerData.bunch_num;
  TriggerData_src_id = input->triggerData.src_id;
  TriggerData_orbit_num = input->triggerData.orbit_num;
  TriggerData_revision_num = input->triggerData.revision_num;
  TriggerData_run_num = input->triggerData.run_num;
  TriggerData_trigger_num = input->triggerData.trigger_num;
  TriggerData_inhibited_triggers_num = input->triggerData.inhibited_triggers_num;
...
//    for(T2TC_it=T2trackCollection->begin(); T2TC_it!=T2trackCollection->end(); T2TC_it++){
//    }



//  cout << TriggerData_event_num << " " << TriggerData_input_status_bits << " "<< T1trackCollection->size() << " "<< T2trackCollection->size()<<endl;
...
void 
T1AnalysisMC_reco3_tree::beginJob()
{
...
void 
T1AnalysisMC_reco3_tree::endJob() 
{
...
void 
T1AnalysisMC_reco3_tree::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
T1AnalysisMC_reco3_tree::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
T1AnalysisMC_reco3_tree::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
T1AnalysisMC_reco3_tree::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
T1AnalysisMC_reco3_tree::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(T1AnalysisMC_reco3_tree);
