...
process = cms.Process("RPMultiReco4000GeV06m")
...
#process.RPStationMultiTrackFinderFitter.ax_cut = 37.77*4*1e-6
#process.RPStationMultiTrackFinderFitter.ax_mean = -40.14e-6
#process.RPStationMultiTrackFinderFitter.ay_cut = 32.88*4*1e-6
#process.RPStationMultiTrackFinderFitter.ay_mean = -1.298e-6
