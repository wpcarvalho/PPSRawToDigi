#include "RecoTotemRP/RPInelasticReconstruction/interface/RPPrimaryVertexInelasticReconstruction.h"
...
void RPPrimaryVertexInelasticReconstruction::InitInverseParametrizationFitter()
{
  ...
  //220 station right
  if(verbosity_)
    std::cout<<"RPPrimaryVertexInelasticReconstruction::InitInverseParametrizationFitter"<<std::cout;
...
void RPPrimaryVertexInelasticReconstruction::beginRun(edm::Run const&, edm::EventSetup const& es)
{
  ...
  edm::LogInfo("RPPrimaryVertexInelasticReconstruction") << "[RPPrimaryVertexInelasticReconstruction::RPPrimaryVertexInelasticReconstruction] Constructing object...";
...
void RPPrimaryVertexInelasticReconstruction::
...
int RPPrimaryVertexInelasticReconstruction::Select220RightHits(const RPFittedTrackCollection &tracks, rec_tracks_collection & coll)
{
  return SelectHits(tracks, coll, station_220_right_ids_);
}


int RPPrimaryVertexInelasticReconstruction::Select220LeftHits(const RPFittedTrackCollection &tracks, rec_tracks_collection & coll)
{
  return SelectHits(tracks, coll, station_220_left_ids_);
}


int RPPrimaryVertexInelasticReconstruction::Select150RightHits(const RPFittedTrackCollection &tracks, rec_tracks_collection & coll)
{
  return SelectHits(tracks, coll, station_150_right_ids_);
}


int RPPrimaryVertexInelasticReconstruction::Select150LeftHits(const RPFittedTrackCollection &tracks, rec_tracks_collection & coll)
{
  return SelectHits(tracks, coll, station_150_left_ids_);
}


void RPPrimaryVertexInelasticReconstruction::Reconstruct(const rec_tracks_collection &rec_col_1, 
