...
RP220Reconst = cms.EDProducer("RPPrimaryVertexInelasticReconstruction_RunI",
    ...
    ParameterizationFileName220Right = cms.string('Geometry/VeryForwardProtonTransport/data/parametrization_6500GeV_90_reco.root'),
    ParameterizationFileName220Left = cms.string('Geometry/VeryForwardProtonTransport/data/parametrization_6500GeV_90_reco.root'),
    ParameterizationFileName150Right = cms.string('Geometry/VeryForwardProtonTransport/data/parametrization_6500GeV_90_reco.root'),
    ParameterizationFileName150Left = cms.string('Geometry/VeryForwardProtonTransport/data/parametrization_6500GeV_90_reco.root'),
