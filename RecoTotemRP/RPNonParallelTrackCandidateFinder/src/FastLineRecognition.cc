...
FastLineRecognition::FastLineRecognition(double cw_a, double cw_b, double _t) :
  chw_a(cw_a/2.), chw_b(cw_b/2.), threshold(_t), geometry(NULL)
{
#ifdef TUNE
