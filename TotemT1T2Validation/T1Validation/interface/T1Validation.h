...
#ifndef _TotemT1T2ValidationT1ValidationT1Validation_H_
#define _TotemT1T2ValidationT1ValidationT1Validation_H_
...
class T1Validation : public edm::EDAnalyzer {
public:
  explicit T1Validation(const edm::ParameterSet&);
  ~T1Validation();
...
std::auto_ptr<TH1D> NReco_Arm1Plane4CSC5;
  ...
  std::auto_ptr<TH2D> RecoXY_00;
  std::auto_ptr<TH2D> RecoXY_01;
  std::auto_ptr<TH2D> RecoXY_02;
  std::auto_ptr<TH2D> RecoXY_03;
  std::auto_ptr<TH2D> RecoXY_04;
  std::auto_ptr<TH2D> RecoXY_10;
  std::auto_ptr<TH2D> RecoXY_11;
  std::auto_ptr<TH2D> RecoXY_12;
  std::auto_ptr<TH2D> RecoXY_13;
  std::auto_ptr<TH2D> RecoXY_14;
...
#endif // TotemT1T2ValidationT1ValidationT1Validation
