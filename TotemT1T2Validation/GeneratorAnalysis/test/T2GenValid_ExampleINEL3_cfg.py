...
#pool_output_dir = '/castor/cern.ch/totem/offline/mcdata/Py8_GenOnlyINEL/'

pool_output_dir = '/castor/cern.ch/totem/offline/mcdata/QGSJET2-04_8TeV_REL445SimAndRec-R-WindowFlange/'
process.load("TotemT1T2Validation.GeneratorAnalysis.T2Generator_cfi")
process.T2Gen.OutputFile = 'QGSJET2-04_8TeV_REL445SimAndRec-R-WindowFlange.root'
