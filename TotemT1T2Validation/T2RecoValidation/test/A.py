...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
    ...
    moduleSeeds = cms.PSet(
        ...
        generator = cms.untracked.uint32(53541),

        g4SimHits = cms.untracked.uint32(94805),

        VtxSmeared = cms.untracked.uint32(88302),

        T2Digis = cms.untracked.uint32(24342),

        T2MCl = cms.untracked.uint32(45057),

    ),

    sourceSeed = cms.untracked.uint32(27531),
