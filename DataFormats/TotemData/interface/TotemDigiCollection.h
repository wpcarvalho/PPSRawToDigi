#ifndef DataFormats_TotemDigiCollection_h
#define DataFormats_TotemDigiCollection_h
...
/**
 * \class DigiContainerIteratorAdaptor TotemDigiCollection.h "/TotemDigiCollection.h"
 * 
...
/**
 * \class TotemDigiCollection TotemDigiCollection.h "/TotemDigiCollection.h"
 *
 ...
 *
 *   \code
 *   typedef TotemDigiCollection<DTDetId,DTDigi> DTDigiCollection
 *   \endcode
 *
 *   \note: Requirements
...
template <typename IndexType, typename DigiType> class TotemDigiCollection {
