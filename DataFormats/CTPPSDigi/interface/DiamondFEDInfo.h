...
#ifndef DataFormats_CTPPSDigi_DiamondFEDInfo
#define DataFormats_CTPPSDigi_DiamondFEDInfo

/**
 * \brief OptoRx headers and footers.
 **/
class DiamondFEDInfo
{
 public:
 DiamondFEDInfo(int _id=0) : fedId(_id), header(0), orbitCounter(0), footer(0)
    {
    }
  ...
  uint16_t getFEDIdFromHeader() const { return (header >> 8) & 0xFFF; }
