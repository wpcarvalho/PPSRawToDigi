...
MultFlatGunSource::MultFlatGunSource( const ParameterSet& pset) :
   fEvt(0)
...
MultFlatGunSource::~MultFlatGunSource()
{
...
void MultFlatGunSource::beginRun(Run& r, EventSetup const& es)
{
