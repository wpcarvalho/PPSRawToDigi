#ifndef RecoLocal_T1MakeClusterMix_h
#define RecoLocal_T1MakeClusterMix_h
...
class T1MakeClusterMix : public edm::EDProducer {
 public:
  /// Constructor
  T1MakeClusterMix(const edm::ParameterSet&);

  /// Destructor
  virtual ~T1MakeClusterMix();
