...
*    
* $Id: Raw2DigiProducer.h 8751 2013-12-17 12:53:28Z fferro $
* $Revision: 8751 $
* $Date: 2013-12-17 13:53:28 +0100 (Tue, 17 Dec 2013) $
*
****************************************************************************/
...
//#include "TotemRawDataLibrary/RawToDigi/interface/T2Mapping.h"

//#include "DataFormats/T1DetId/interface/T1DetId.h"
//#include "TotemRawDataLibrary/RawToDigi/interface/T1FisChannel.h"
...
//#include "TotemRawDataLibrary/RawToDigi/interface/T1Cfecs.h"
...
class Raw2DigiProducer : public edm::EDProducer
{
 ...
 private:
  ...
  // error summary
  std::map<Totem::FramePosition, std::map<Totem::VFATStatus, unsigned int> > errorSummary;
