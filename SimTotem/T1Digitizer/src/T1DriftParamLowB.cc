...
double T1DriftSim::avgPathLengthLowB() {
  ...
  /*                                                                      *
   */
  /* DOC  Returns     : Drift path length for low field T1 chambers      *
   */
  /*                                                                      *
   */
...
double T1DriftSim::pathSigmaLowB() {
  /* Initialized data */
  ...
  /* DOC  Function    : Parameterization of the drift path length          *
   */
  /* DOC                dispersion in the muon endcap T1s.                *
   */
  /*                                                                      *
   */
  /* DOC  References  : None                                               *
  ...
  /*                                                                      *
   */
  /* DOC  Returns     : Path length dispersion for low field T1 chambers *
   */
  /*                                                                      *
   */
  /* DOC  Created     : 15-OCT-1996   Author : Jeff Rowe                   *
...
double T1DriftSim::avgDriftTimeLowB() {
  /* Initialized data */
  ...
  /*                                                                      *
   */
  /* DOC  Returns     : Drift time for low field T1 chambers              *
   */
  /*                                                                      *
   */
  /* DOC  Created     : 15-OCT-1996   Author : Jeff Rowe                   *
...
double T1DriftSim::driftTimeSigmaLowB() {
  /* Initialized data */
  ...
  /* Local variables */
  double x11, x20, x21, x22, x23, x24, x25, x26, x27, x28,
    x29, x210, x211, x212;
  ...
  /*                                                                      *
   */
  /* DOC  Returns     : Drift time dispersion for low field T1 chambers   *
   */
  /*                                                                      *
   */
  /* DOC  Created     : 15-OCT-1996   Author : Jeff Rowe                   *
