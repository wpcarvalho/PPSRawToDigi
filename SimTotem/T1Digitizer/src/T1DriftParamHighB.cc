...
double T1DriftSim::avgPathLengthHighB() {
  /* Initialized data */
...
double T1DriftSim::pathSigmaHighB() {
  /* Initialized data */
  ...
  /* Local variables */
  double x11, x12, x13, x14, x15, x16, x21, x22, x23,
...
double T1DriftSim::avgDriftTimeHighB() {
  /* Initialized data */
...
double T1DriftSim::driftTimeSigmaHighB() {
  /* Initialized data */
  ...
  /* Local variables */
  double x10, x11, x12, x13, x14, x15, x16, x17, x18, x20,
