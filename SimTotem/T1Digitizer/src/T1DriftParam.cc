...
double T1DriftSim::avgDrift() const{
  /* Initialized data */
  ...
  /* ! Parameterization of Lorentz drift in T1s */
  /* ***********************************************************************
   * DOC MC_ALL_BDFT                                                       *
   *                                                                       *
...
double T1DriftSim::driftSigma() const {
  // Initialized data 

  static const double coeff[3] = { .01069525,.010364504,.0021662697 };


  /* ! Parameterization of Lorentz drift error in T1s */
  /*************************************************************************
   * DOC MC_ALL_BSIG                                                       *
   *                                                                       *
