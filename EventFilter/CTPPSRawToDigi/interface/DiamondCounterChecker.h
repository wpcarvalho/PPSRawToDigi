...
#ifndef EventFilter_CTPPSRawToDigi_DiamondCounterChecker
#define EventFilter_CTPPSRawToDigi_DiamondCounterChecker
...
template<typename T>
void DiamondCounterChecker::Analyze(T &status, bool error, std::ostream &es) 
{  
