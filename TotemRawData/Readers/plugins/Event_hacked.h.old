...
/**
 * This is a copy of
 *   src/FWCore/Framework/interface/Event.h
 * with RawDataSource and RawDataMappingSources added as friends.
 */
...
namespace edm {
  ...
  private:
    ...
    friend class ::RawDataSource;
    friend class ::RawDataMappingSource;
