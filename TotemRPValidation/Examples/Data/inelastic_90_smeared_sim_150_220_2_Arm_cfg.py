...
process.load("RecoTotemRP.RPInelasticReconstruction.RP2Arm150220Beta90_cfi")
process.RP150220Reconst.BeamProtTransportSetup = process.BeamProtTransportSetup
process.RP150220Reconst.Verbosity = 1

process.load("TotemRPValidation.InelasticReconstructionValidation.Inelastic2ArmRecValidation_90_cfi")
process.RPInelProtRecVal.HistogramFileName = 'RPInelasticRecValHistsBeta2DiffractiveMass90_150_220_2_Arm.root'
process.RPInelProtRecVal.Verbosity = 1

process.HitDists = cms.EDAnalyzer("HitDistributions",
    verbosity = cms.untracked.uint32(0),
    outputFile = cms.string('hitDistributions_beta_90_150_220_2_sided_rec.root'),
...
process.o1 = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('inelastic_90_150_220_2_Arm.root')
)

process.p1 = cms.Path(process.SmearingGenerator*process.g4SimHits*process.mix*process.RPSiDetDigitizer*process.RPClustProd*process.RPHecoHitProd*process.RPSinglTrackCandFind*process.RPSingleTrackCandCollFit*process.HitDists*process.RP150220Reconst*process.RPInelProtRecVal*process.RPRecTracksVal)
