...
# Monte Carlo gun
process.load("IOMC.FlatProtonLogKsiLogTGun.DebugGunConfig_low_beta_cfi")
...
process.load("RecoTotemRP.RPInelasticReconstruction.Rec_beta_2_220_cfi")
process.RP220Reconst.BeamProtTransportSetup = process.BeamProtTransportSetup
process.RP220Reconst.Verbosity = 1

process.load("TotemRPValidation.InelasticReconstructionValidation.InelasticReconstVal_2_cfi")
process.RPInelProtRecVal.HistogramFileName = 'RPInelasticRecValHistsBeta2.root'
...
process.o1 = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('inelastic_2_smeared_sim.root')
)
