...
process.ModifySingularModes.inputFile = '/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_10_24-25_2b//sr/45_220.xml'
process.ModifySingularModes.outputFile = '/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_10_24-25_2b//sr+hsx/45_220.xml'

process.TotemRPIncludeAlignments.RealFiles = cms.vstring('/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_10_24-25_2b//sr/45_220.xml')

process.ModifySingularModes.z1 = 214628*sign # near vert
process.ModifySingularModes.z2 = 220000*sign # far vert

process.ModifySingularModes.de_x1 = -.873
process.ModifySingularModes.de_x2 = -.735
