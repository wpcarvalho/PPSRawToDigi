...
process.ModifySingularModes.inputFile = '/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_07_12-13//sr/56_220.xml'
process.ModifySingularModes.outputFile = '/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_07_12-13//sr+hsx/56_220.xml'

process.TotemRPIncludeAlignments.RealFiles = cms.vstring('/afs/cern.ch/exp/totem/scratch/jkaspar/software/offline/424/src/TotemAlignment/RPData/LHC/2012_07_12-13//sr/56_220.xml')

process.ModifySingularModes.z1 = 214628*sign # near vert
process.ModifySingularModes.z2 = 220000*sign # far vert

process.ModifySingularModes.de_x1 = -.021
process.ModifySingularModes.de_x2 = -.738
