...
# process.t1cluster.T1DigiSantiardCollectionLabel = cms.InputTag("T1Digis")
# process.t1cluster.T1DigiVfatCollectionLabel = cms.InputTag("T1Digis")
#process.t1rechit.T1ClusterCollectionLabel = cms.InputTag("t1cluster")
#process.t1rechit.T1DigiWireCollectionLabel = cms.InputTag("T1Digis")
