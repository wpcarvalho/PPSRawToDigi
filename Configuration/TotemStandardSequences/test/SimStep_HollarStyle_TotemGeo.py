...
#process.load('Configuration.StandardSequences.GeometrySimDB_cff')#merijn changed:
#process.load('Geometry.CMSCommonData.cmsExtendedGeometry2015XML_cfi') Totem  geo
...
# Other statements
#process.XMLFromDBSource.label = cms.string("ExtendedPostLS1") #merijn removed
