...
# with command line options: --filein file:MinbiasTest_GEN.root --fileout file:MinbiasTest_SIM.root --mc --eventcontent RAWSIM --pileup NoPileUp --customise Configuration/StandardSequences/SimWithCastor_cff.customise, SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1, Configuration/DataProcessing/Utils.addMonitoring --datatier SIM --conditions POSTLS170_V5::All --magField 38T_PostLS1 --geometry DBExtendedPostLS1 --step SIM --python_filename SimStep_Standalone_cfg_AutoGen_IncCastor.py --no_exec -n 1
...
#above are automatic statements. Below is put in manualy
...
#This will force the common geometry file gets loaded, forcing T1 and T2 in as well.
#process.load("Configuration.TotemCommon.geometryT1T2CMS_cfi")


#Here we force manually the geant seeds to fixed values to allow for good comparison between various settings
