...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml', 
        ...
        'Geometry/TotemRPData/data/OneRPTestBeam/RP_Detectors_Assembly.xml', 
        'Geometry/TotemRPData/data/OneRPTestBeam/RP_Stations_Assembly.xml', 
        'Geometry/TotemRPData/data/OneRPTestBeam/RP_Dist_Beam_Cent.xml', 
