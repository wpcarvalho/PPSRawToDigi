...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    ...
    #    'Geometry/ForwardSimData/data/TotemProdCuts.xml')),  # DIFF: TOTEM only Merijn 2015 march 2nd: move the cuts out, they affect CMS results. We still get results for Totem but these differ. This results correspond to the results one would get using totemProdCuts instead.
