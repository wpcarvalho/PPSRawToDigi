...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:CMS-SIM.root')
)
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:CMS-RECO.root'),
...
process.schedule.extend([process.raw2digi_step,process.L1Reco_step,process.endjob_step,process.RECOoutput_step])
