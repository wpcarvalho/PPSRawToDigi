...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring("file:TOTEM-RECO.root"),
...
process.RPHitDists.outputFile = cms.string('file:TOTEM-RPHITS.root')

process.load("TotemAnalysis.TotemNtuplizer.TotemNtuplizer_cfi")
process.TotemNtuplizer.outputFileName = 'file:TOTEM-NTUPLE.root'
