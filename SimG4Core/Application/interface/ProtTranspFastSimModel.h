...
*
* $$RCSfile: ProtTranspFastSimModel.h,v $: $
* $Revision: 1.1.1.1.6.2 $
* $Date: 2009/11/16 16:56:06 $
*
****************************************************************************/

#ifndef SimG4Core_TotemRPPRotTransp_ProtTranspFastSimModel_h_
#define SimG4Core_TotemRPPRotTransp_ProtTranspFastSimModel_h_
 ...
 **/
class ProtTranspFastSimModel : public G4VFastSimulationModel
{
  public:
    enum type{BEAM_IP_150_R, BEAM_IP_150_L, NOT_DEF};

    /// Constructor
    ProtTranspFastSimModel(G4String ModelVolumeName, G4Envelope* envelope, 
...
#endif  //SimG4Core_TotemRPPRotTransp_ProtTranspFastSimModel_h_
