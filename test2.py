...
process.o1 = cms.OutputModule("PoolOutputModule",
                              outputCommands=cms.untracked.vstring('keep *', 'drop *_*mix*_*_*', 'drop *_*_*Muon*_*',
                              ...
                              fileName=cms.untracked.string('file:' + fileNamePrefix + 'Ntuplizer.root')
                              )
...
#process.TotemNtuplizer.outputFileName = fileNamePrefix + "Ntuple.root"
